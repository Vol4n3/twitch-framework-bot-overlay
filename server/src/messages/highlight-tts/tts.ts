 ...
 * @returns 
 */
export const TTS = async (message:string ,voice = 'Microsoft Paul',speed = 0 ): Promise<void>=>{
    ...
    const spawn = childProcess.spawn('chcp 65001 >NUL & powershell.exe', [arg], {shell:true});
